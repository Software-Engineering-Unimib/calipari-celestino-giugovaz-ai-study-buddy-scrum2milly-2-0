...
public class AIController {
    ...
    public ResponseEntity<ExplanationResponse> getExplanation(
        ...
        logger.info("Richiesta spiegazione '{}' da utente: {}, lingua: {}", 
                topic, user.getEmail(), user.getPreferredLanguage());
    ...
    /**
     * Endpoint di debug per verificare la lingua dell'utente
     */
    @GetMapping("/debug/language")
    public ResponseEntity<Map<String, Object>> debugLanguage(Principal principal) {
        User user = userService.getCurrentUser(principal);
