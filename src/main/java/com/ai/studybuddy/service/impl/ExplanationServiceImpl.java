...
public class ExplanationServiceImpl implements ExplanationService {
    ...
    public ExplanationResponse generateExplanation(String topic, String level, String subject, User user) {
        ...
        // Ottieni lingua utente (default "it" se null)
        String userLanguage = user.getPreferredLanguage() != null ? user.getPreferredLanguage() : "it";

        // 1. Genera la spiegazione con AI (passa lingua)
        String explanation = aiService.generateExplanation(topic, mapLevel(level), userLanguage);
